const translations = {
  en: {
    ...
    nextRound: "Next round", waiting: "Waiting for a rival…", ready: "READY", readyCount: "{count}/{max} players ready", incoming: "+{count} incoming", countdown: "Arena in {count}", hostLeft: "The arena host left", winner: "Arena winner", eliminated: "Stack broken",
    recordsEmpty: "No records yet", recordsLoading: "Loading records…", muted: "Sound off", unmuted: "Sound on", best: "Best {score}", playArena: "Play"
  },
  mn: {
    ...
    nextRound: "Дараагийн үе", waiting: "Өрсөлдөгч хүлээж байна…", ready: "БЭЛЭН", readyCount: "{count}/{max} тоглогч бэлэн", incoming: "+{count} мөр ирж байна", countdown: "Тулаан {count}", hostLeft: "Тулааны эзэн гарлаа", winner: "Тулааны ялагч", eliminated: "Өрөлт нурлаа",
    recordsEmpty: "Одоогоор рекорд алга", recordsLoading: "Рекорд ачаалж байна…", muted: "Дуу хаалттай", unmuted: "Дуу нээлттэй", best: "Шилдэг {score}", playArena: "Тоглох"
  }
} as const;
